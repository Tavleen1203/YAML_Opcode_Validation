...
def main():
    parser = argparse.ArgumentParser(description='Validate opcode definitions.')
    parser.add_argument('yaml_file', help='Path to the YAML file containing opcode definitions.')
    ...
    validator = OpcodeValidator(args.yaml_file, argument_lookup)
